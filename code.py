...
print('Top 10 countries in Summer : \n',top_10_summer)

print('Top 10 countries in Winter : \n',top_10_winter)

print('Top 10 countries won highest medals : \n',top_10)
...
#Code starts here
data_1 = data[:-1]
data_1 = data_1.drop(['Total_Medals'], axis =1)
